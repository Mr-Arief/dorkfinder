...
def sukses(no1,pro,nam):
  print("     %s[%s%s%s] [%s Sent %s] %sSuccess, spam %s from %s%s %ssended"%(pu,ku,pu,hi,pu,pu,ku)
def gagal(no1,pro,nam):
  print("     %s[%s%s%s] [%s Failed  %s] %sFailed, spam %s from %s%s %snot sended"%(pu,ku,pu,hi,pu,pu,ku)
#--------------------------------MAIN---------------------------------------------------
def main():
...
def logo():
  print("""%s
  __  __ ___    ___                                   
 |  \/  |   \  / __|_ __  __ _ _ __  _ __  ___ _ _ ___ %sAuthor by %FireMe%s
 | |\/| | |) | \__ \ '_ \/ _` | '  \| '  \/ -_) '_(_-< %sGithub %sgithub.com/Mr-Gabut%s
 |_|  |_|___/  |___/ .__/\__,_|_|_|_|_|_|_\___|_| /__/ %sTeam %Github Recoder%s
